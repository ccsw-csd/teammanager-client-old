...
export class PersonalCalendarService {
  ...
  saveAbsencePersonal(absences: PersonAbsenceDto[], dates: Date[]): Observable<void>{
    return this.http.post<void>(environment.server + '/personAbsence/save/', {dates, absences});
  }
